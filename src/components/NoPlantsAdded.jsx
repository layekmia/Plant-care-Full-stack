...
export default function NoPlantsAdded() {
  return (
    <div className="min-h-[100vh] dark:bg-dark-background flex flex-col items-center justify-start pt-[120px] text-center px-4">
      ...
      <p className="text-gray-600 dark:text-gray-400 text-lg md:text-xl mb-6 max-w-xl">
