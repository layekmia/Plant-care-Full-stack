...
export default function NewPlants() {
  return (
    <div className="py-12 md:py-16 lg:py-24">
      <h2 className="max-w-fit mx-auto pb-1 mb-10 text-center  text-2xl lg:text-3xl text-stone-700 font-poppins font-semibold uppercase border-b-2 ">
        New Plants
      </h2>
      <div className="max-w-7xl mx-auto px-5 md:px-8  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {newPlants.map((plant) => (
          <div key={plant.id} className="relative">
            ...
            <button className=" text-stone-600 text-lg mt-2">Learn more</button>
          </div>
        ))}
      </div>
    </div>
